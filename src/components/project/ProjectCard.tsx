  ...
  return (
    <a href={project.github ?? project.live!} className='grid content-start hover:-translate-y-2 transition-all duration-300 group'>
      <div className='relative'>
        ...
        <div className="absolute inset-0 bg-black/80 rounded-t-xl opacity-0 group-hover:opacity-100 transition-all delay-100 duration-300 grid place-content-center text-lg font-semibold"> <div className="inline-flex items-center gap-2">View Project <ArrowRightIcon /></div></div>
      </div>
