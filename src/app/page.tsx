  ...
  return (
    <div className='pt-navbar h-dvh grid content-center text-center px-4'>
      ...
      <div className='justify-center ma'>
        <Link className='py-3 px-4 font-medium hover:px-6 transition-all hover:shadow-2xl border-2 border-slate-50 rounded-lg inline-flex whitespace-pre' href={'contact'}>
          Let&apos;s work together 👌 
        </Link>
      </div>
    </div>
